...
// UnimplementedTypeMailServiceServer must be embedded to have
...
func (UnimplementedTypeMailServiceServer) testEmbeddedByValue()                         {}
...
func RegisterTypeMailServiceServer(s grpc.ServiceRegistrar, srv TypeMailServiceServer) {
	// If the following call pancis, it indicates UnimplementedTypeMailServiceServer was
