...
// UnimplementedMailStatusServiceServer must be embedded to have
...
func (UnimplementedMailStatusServiceServer) testEmbeddedByValue()                           {}
...
func RegisterMailStatusServiceServer(s grpc.ServiceRegistrar, srv MailStatusServiceServer) {
	// If the following call pancis, it indicates UnimplementedMailStatusServiceServer was
