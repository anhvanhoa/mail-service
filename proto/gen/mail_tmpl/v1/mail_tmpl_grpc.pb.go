...
// UnimplementedMailTmplServiceServer must be embedded to have
...
func (UnimplementedMailTmplServiceServer) testEmbeddedByValue()                         {}
...
func RegisterMailTmplServiceServer(s grpc.ServiceRegistrar, srv MailTmplServiceServer) {
	// If the following call pancis, it indicates UnimplementedMailTmplServiceServer was
