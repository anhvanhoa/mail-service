...
// UnimplementedStatusHistoryServiceServer must be embedded to have
...
func (UnimplementedStatusHistoryServiceServer) testEmbeddedByValue()                              {}
...
func RegisterStatusHistoryServiceServer(s grpc.ServiceRegistrar, srv StatusHistoryServiceServer) {
	// If the following call pancis, it indicates UnimplementedStatusHistoryServiceServer was
