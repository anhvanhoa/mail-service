...
// UnimplementedMailHistoryServiceServer must be embedded to have
...
func (UnimplementedMailHistoryServiceServer) testEmbeddedByValue()                            {}
...
func RegisterMailHistoryServiceServer(s grpc.ServiceRegistrar, srv MailHistoryServiceServer) {
	// If the following call pancis, it indicates UnimplementedMailHistoryServiceServer was
